USE [ODS_production]
GO
/****** Object:  Table [dbo].[L56_DOD_SCFF]    Script Date: 5/23/2023 3:04:15 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[L56_DOD_SCFF]') AND type in (N'U'))
