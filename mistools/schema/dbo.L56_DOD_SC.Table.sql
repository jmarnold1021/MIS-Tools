USE [ODS_production]
GO
/****** Object:  Table [dbo].[L56_DOD_SC]    Script Date: 5/12/2023 12:01:39 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[L56_DOD_SC]') AND type in (N'U'))
