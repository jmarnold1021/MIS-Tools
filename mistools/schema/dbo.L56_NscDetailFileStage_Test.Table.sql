DROP TABLE [dbo].[L56_NscDetailFileStage_Test]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[L56_NscDetailFileStage_Test]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[L56_NscDetailFileStage_Test](
	[SSN] [varchar](16) NULL,
